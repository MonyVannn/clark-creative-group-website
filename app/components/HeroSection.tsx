...
export default function HeroSection() {
  ...
  return (
    <section className="absolute inset-0 container mx-auto flex">
      ...
      <div className="w-full h-fit relative top-1/4">
        <SplitText
          text="Crafting Life"
          as="h1"
          className="font-clash-display text-8xl font-semibold text-white leading-none uppercase tracking-wide"
          triggerOnLoad
          initialDelay={0}
        />
        <SplitText
        ...
        <SplitText
          ...
          as="h1"
          className="font-clash-display text-2xl font-medium text-white leading-none uppercase tracking-wide"
          triggerOnLoad
          initialDelay={0}
        />
      </div>
      ...
      <div className="absolute bottom-1/4 right-0 flex justify-end">
        <div
          ref={descRef}
          className="font-satoshi font-medium text-lg max-w-sm space-y-6 opacity-0"
        >
