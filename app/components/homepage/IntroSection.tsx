  ...
  return (
    <section className="intro-section relative w-full px-8 py-28 md:px-12 lg:px-16 overflow-x-clip md:overflow-visible">
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center gap-14 md:gap-16 lg:gap-20">
        <CopyReveal
          as="div"
          className={`font-satoshi text-3xl font-medium leading-tight text-center md:text-3xl lg:text-4xl transition-colors duration-1400 ${
        ...
        <CopyReveal
          as="div"
          className={`font-clash-display -mt-12 text-center text-4xl font-semibold md:text-5xl lg:text-6xl transition-colors duration-1400 ${
            isDarkTheme ? "text-[#f6f8ff]" : "text-[#0a191f]"
          }`}
          stagger={0.08}
          delay={0.2}
