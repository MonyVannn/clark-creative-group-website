    ...
    <main className="relative min-h-screen bg-transparent">
      ...
      <div className="relative overflow-hidden">
        <div className="relative z-10 flex min-h-[74vh] flex-col items-center justify-center px-6 pb-20 pt-28 text-center md:px-10">
          <p className="mb-4 font-satoshi text-xs font-semibold uppercase tracking-[0.35em] text-foreground">
            Page Not Found
          </p>
          ...
          <p className="mt-6 max-w-xl font-satoshi text-sm leading-relaxed text-foreground md:text-base">
